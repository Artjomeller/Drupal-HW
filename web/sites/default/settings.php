 ...
 * @endcode
 */
$settings['hash_salt'] = 'xU93WvRm-HwBJ_W89Wbe8Nv-90Bo6A3_AvV97hidKbBo8r5CVPg-t-3Fx9zIIcZsel4vz12oUA';
...
$settings['config_sync_directory'] = 'sites/default/files/config_fD1bjKT8zQ261eXrb8I7OSgE31ass-X55FsFnxYqD00vsZ195SM49n7xsnSeDNr3E4QUDOhmdA/sync';

// Redis cache seadistus (ettevaatlik versioon)
if (extension_loaded('redis')) {
  $settings['redis.connection']['interface'] = 'PhpRedis';
  $settings['redis.connection']['host'] = 'redis';
  $settings['redis.connection']['port'] = 6379;
  // Ainult session cache, mitte kõik
  $settings['session.save_handler'] = 'redis';
  $settings['session.save_path'] = 'tcp://redis:6379';
}
