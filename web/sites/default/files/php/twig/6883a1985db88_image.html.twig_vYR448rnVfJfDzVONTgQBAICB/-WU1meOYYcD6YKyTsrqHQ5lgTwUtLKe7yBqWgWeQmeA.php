...
class __TwigTemplate_c90a99a5e354f4fd05fcba65c5d708b7 extends Template
{
...
($context["style_name"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (("image-style-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["style_name"] ?? null), 15, $this->source)))) : (""))];
        // line 18
        yield "<img";
