...
class __TwigTemplate_09466f9ecbebef469a913020640c650d extends Template
{
...
($context["header"] ?? null), 38, $this->source))), (((($tmp =         // line 39
        ...
        ";
            ...
            foreach ($context['_seq'] as $context["key"] => $context["column"]) {
                ...
                if ((($tmp = CoreExtension::getAttribute($this->env, $this->source, $context["column"], "default_classes", [], "any", false, false, true, 60)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) {
                    ...
                    yield "            ";
                    // line 62
                    $context["column_classes"] = ["views-field", ("views-field-" . $this->sandbox->ensureToStringAllowed((($_v0 =                     // line 64
($context["fields"] ?? null)) && is_array($_v0) || $_v0 instanceof ArrayAccess && in_array($_v0::class, CoreExtension::ARRAY_LIKE_CLASSES, true) ? ($_v0[$context["key"]] ?? null) : CoreExtension::getAttribute($this->env, $this->source, ($context["fields"] ?? null), $context["key"], [], "array", false, false, true, 64)), 64, $this->source))];
                    // line 67
                    yield "          ";
                }
                // line 68
