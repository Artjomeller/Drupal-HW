...
class __TwigTemplate_84a75d8a0df80384f5833d8c0ec2850d extends Template
{
...
($context["display_id"] ?? null), 41, $this->source)), "grid-full", "layout--pass--content-narrow", (((($tmp =         // line 44
($context["dom_id"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (("js-view-dom-id-" . $this->sandbox->ensureToStringAllowed(($context["dom_id"] ?? null), 44, $this->source))) : (""))];
        // line 47
        yield "<div";
