...
class __TwigTemplate_dbd22bdfcd46ac88d2ebab12f0387eda extends Template
{
...
($context["name"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (\Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["name"] ?? null), 23, $this->source))) : ("")), (((($tmp =         // line 24
