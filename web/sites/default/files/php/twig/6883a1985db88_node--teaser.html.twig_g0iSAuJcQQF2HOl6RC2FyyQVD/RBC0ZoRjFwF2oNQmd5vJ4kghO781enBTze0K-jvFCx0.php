...
class __TwigTemplate_8aa431e6081e4eabe28605b55407a5e4 extends Template
{
...
($context["node"] ?? null), "bundle", [], "any", false, false, true, 67), 67, $this->source))), (((($tmp = CoreExtension::getAttribute($this->env, $this->source,         // line 68
...
($context["view_mode"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 71, $this->source)))) : (""))];
        // line 74
        yield "

";
        // line 76
        yield from $this->load("core/themes/olivero/templates/content/node--teaser.html.twig", 76, "1304523408")->unwrap()->yield(CoreExtension::toArray(["attributes" => CoreExtension::getAttribute($this->env, $this->source,         // line 77
...
/* core/themes/olivero/templates/content/node--teaser.html.twig */
class __TwigTemplate_8aa431e6081e4eabe28605b55407a5e4___1304523408 extends Template
{
    private Source $source;
    /**
     * @var array<string, Template>
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->load("olivero:teaser", 76);
