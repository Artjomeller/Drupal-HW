...
class __TwigTemplate_967566acea51cd3c06fcceded5ece6b7 extends Template
{
...
($context["display_id"] ?? null), 38, $this->source)), (((($tmp =         // line 39
($context["dom_id"] ?? null)) && $tmp instanceof Markup ? (string) $tmp : $tmp)) ? (("js-view-dom-id-" . $this->sandbox->ensureToStringAllowed(($context["dom_id"] ?? null), 39, $this->source))) : (""))];
        // line 42
        yield "<div";
